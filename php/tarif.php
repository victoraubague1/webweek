      ...
      include '../php/config.php';
        ...
        try {
            ...
            foreach ($tarifs as $tarif) {
                ...
                echo "            <h3 class='card-title'><div class='souligner'>   $categ</div></h3>";
                echo "            <p class='card-text'>Pour les joueurs avancés.</p>";
                echo "            <h4>$prix € / an</h4>";
                echo "            <ul class='list-unstyled'>";
                echo "                <li> pr les jeunes</li>";
                echo "                <li> jsp</li>";
                echo "                <li>jsp</li>";
                echo "            </ul>";
                echo "            <a href='#' class='btn btn-primary highlight-button'>S'inscrire</a>";
                echo "        </div>";
                echo "    </div>";
                echo "</div>";
            }
